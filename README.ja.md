...
* **ピン留め国フィルター & 多角ビュー:** 主要国（日本、米国、中国、韓国等）をワンクリックで絞り込めるピルボタンとドロップダウンセレクター。12件ごとのグリッド（ミニマルカード）・全65事象を完全プロットしたインタラクティブ世界地図・複数年代展開と関係年代注釈・年代/カテゴリ/注釈絞り込み対応の時系列年表の3つのビューで探索可能。
