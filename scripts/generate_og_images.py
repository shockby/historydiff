...
COUNTRY_FLAGS = {
    ...
    'ベネズエラ': '🇻🇪', 'Venezuela': '🇻🇪', '委内瑞拉': '🇻🇪', '베네수엘라': '🇻🇪',
    'ガイアナ': '🇬🇾', 'Guyana': '🇬🇾', '圭亚那': '🇬🇾', '가이아나': '🇬🇾',
    'ボリビア': '🇧🇴', 'Bolivia': '🇧🇴', '玻利维亚': '🇧🇴', '볼리비아': '🇧🇴',
    'チリ': '🇨🇱', 'Chile': '🇨🇱', '智利': '🇨🇱', '칠레': '🇨🇱',
    '国際社会（国連）': '🇺🇳', 'United Nations / International Community': '🇺🇳', '国連': '🇺🇳', 'United Nations': '🇺🇳',
    '米国・英語圏': '🇺🇸', 'United States / Western': '🇺🇸',
    'ガイアナ・ベネズエラ': '🇬🇾🇻🇪', 'Guyana & Venezuela': '🇬🇾🇻🇪',
    'ボリビア・チリ': '🇧🇴🇨🇱', 'Bolivia & Chile': '🇧🇴🇨🇱',
    'コンゴ民主共和国・ルワンダ': '🇨🇩🇷🇼', 'DRC & Rwanda': '🇨🇩🇷🇼', 'コンゴ民主共和国': '🇨🇩', 'ルワンダ': '🇷🇼',
    'エチオピア': '🇪🇹', 'Ethiopia': '🇪🇹', 'エジプト': '🇪🇬', 'Egypt': '🇪🇬',
    'エチオピア・エジプト・スーダン': '🇪🇹🇪🇬🇸🇩', 'Ethiopia, Egypt & Sudan': '🇪🇹🇪🇬🇸🇩',
    'マリ・ブルキナファソ・ニジェール・フランス': '🇲🇱🇧🇫🇳🇪🇫🇷', 'Mali, Burkina Faso & Niger': '🇲🇱🇧🇫🇳🇪', 'マリ・ブルキナファソ・ニジェール': '🇲🇱🇧🇫🇳🇪',
    'ソマリア・ソマリランド': '🇸🇴', 'Somalia & Somaliland': '🇸🇴', 'ソマリランド': '🇸🇴', 'ソマリア': '🇸🇴', 'Somalia': '🇸🇴',
}
